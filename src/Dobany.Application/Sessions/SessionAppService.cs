...
{
    public class SessionAppService : DobanyAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = DobanyConsts.Currency,
                    CurrencySign = DobanyConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = DobanyConsts.AllowTenantsToChangeEmailSettings,
