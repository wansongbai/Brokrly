...
namespace Dobany.Web.Public.Startup
{
    [DependsOn(
        typeof(DobanyWebCoreModule)
    )]
    public class DobanyWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public DobanyWebFrontEndModule(IWebHostEnvironment env, DobanyEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(DobanyWebFrontEndModule).GetAssembly());
        }
    }
}
