...
using Dobany.DynamicEntityPropertyValues.Dto;

namespace Dobany.DynamicEntityProperties
{
    [Authorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : DobanyAppServiceBase, IDynamicEntityPropertyValueAppService
    {
