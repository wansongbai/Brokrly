...
using Dobany.MultiTenancy.HostDashboard;
...
namespace Dobany.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(DobanyDbContext context, SubscriptionPayment subscriptionPayment)
        {
