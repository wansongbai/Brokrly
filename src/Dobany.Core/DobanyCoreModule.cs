...
using Dobany.Authorization.Ldap;
using Dobany.Authorization.Roles;
using Dobany.Authorization.Users;
using Dobany.Chat;
using Dobany.Configuration;
using Dobany.DashboardCustomization.Definitions;
using Dobany.Debugging;
using Dobany.DynamicEntityProperties;
using Dobany.Features;
using Dobany.Friendships;
using Dobany.Friendships.Cache;
using Dobany.Localization;
using Dobany.MultiTenancy;
using Dobany.Net.Emailing;
using Dobany.Notifications;
using Dobany.WebHooks;

namespace Dobany
{
    [DependsOn(
        typeof(DobanyCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class DobanyCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            DobanyLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = DobanyConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, DobanyMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<DobanySmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(DobanyCoreModule).GetAssembly());
        }
