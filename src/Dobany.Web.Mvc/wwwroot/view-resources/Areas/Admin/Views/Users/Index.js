(function () {
    $(function () {
        ...
        var _dynamicPropertiesModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Admin/DynamicEntityPropertyValues/ManageDynamicEntityPropertyValuesModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Admin/Views/_Bundles/manage-dynamic-entity-property-values-modal-min.js',
                        ...
                        items: [{
                            ...
                            action: function (data) {
                                _dynamicPropertiesModal.open({
                                    entityFullName: 'Dobany.Authorization.Users.User',
