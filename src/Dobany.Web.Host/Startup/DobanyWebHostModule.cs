...
using Dobany.Web.Startup.ExternalLoginInfoProviders;
...
namespace Dobany.Web.Startup
{
    ...
    public class DobanyWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public DobanyWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(DobanyWebHostModule).GetAssembly());
        }
