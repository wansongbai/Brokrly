(function () {
    $(function () {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Admin/WebhookSubscription/EditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Admin/Views/WebhookSubscriptions/_CreateOrEditModal.js',
                ...
                },
                {
                    ...
                    rowAction: {
                        ...
                        },
                        {
                            ...
                            action: function (data) {
                                window.location = "/Admin/WebhookSubscription/WebhookEventDetail/" + data.record.webhookEventId;
                            }
                        }]
                    }
                },
