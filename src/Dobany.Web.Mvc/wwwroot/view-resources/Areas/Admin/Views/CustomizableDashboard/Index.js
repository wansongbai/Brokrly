$(function () {
    ...
    var _addWidgetModal = new app.ModalManager({
        viewUrl: abp.appPath + 'Admin/' + $('#DashboardName').val() + '/AddWidgetModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/Admin/Views/CustomizableDashboard/_AddWidgetModal.js',
