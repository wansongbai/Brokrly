...
{
    public class StripeGatewayManager : DobanyServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Dobany";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + DobanyConsts.Currency;
        }
