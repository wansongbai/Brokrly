...
namespace Dobany.Migrations
{
    ...
    [Migration("20210317122249_add-mirgation add-avatar")]
    partial class addmirgationaddavatar
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dobany.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Dobany.Channels.Channel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Dobany.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Dobany.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Dobany.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("ChannelUser", b =>
                {
                    b.HasOne("Dobany.Channels.Channel", null)
                        .WithMany()
