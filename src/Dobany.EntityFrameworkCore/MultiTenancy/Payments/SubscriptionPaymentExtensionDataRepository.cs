...
{
    public class SubscriptionPaymentExtensionDataRepository : DobanyRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<DobanyDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
