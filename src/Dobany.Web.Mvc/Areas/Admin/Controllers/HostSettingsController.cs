...
using Dobany.Configuration.Host;
using Dobany.Editions;
using Dobany.Timing;
using Dobany.Timing.Dto;
using Dobany.Web.Areas.Admin.Models.HostSettings;
...
namespace Dobany.Web.Areas.Admin.Controllers
{
    ...
    public class HostSettingsController : DobanyControllerBase
    {
