...
{
    public class DobanyDbContext : AbpZeroDbContext<Tenant, Role, User, DobanyDbContext>, IAbpPersistedGrantDbContext
    {
        ...
        public DobanyDbContext(DbContextOptions<DobanyDbContext> options)
            : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Channel>().HasMany(x => x.Members).WithMany(x => x.Channels);
