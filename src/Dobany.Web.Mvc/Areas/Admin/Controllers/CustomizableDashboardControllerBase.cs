...
using Dobany.Web.Areas.Admin.Models.CustomizableDashboard;
...
{
    public abstract class CustomizableDashboardControllerBase : DobanyControllerBase
    {
        ...
        public async Task<PartialViewResult> AddWidgetModal(string dashboardName, string pageId)
        {
            var userDashboard = await DashboardCustomizationAppService.GetUserDashboard(
                new GetDashboardInput
                {
                    ...
                    Application = DobanyDashboardCustomizationConsts.Applications.Mvc
                }
            );
            ...
            return PartialView("~/Areas/Admin/Views/Shared/Components/CustomizableDashboard/_AddWidgetModal.cshtml", viewModel);
        }
        ...
        protected async Task<ActionResult> GetView(string dashboardName)
        {
            ...
            return View("~/Areas/Admin/Views/Shared/Components/CustomizableDashboard/Index.cshtml",
