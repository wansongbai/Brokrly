...
using Dobany.Auditing.Exporting;
using Dobany.Authorization;
using Dobany.Authorization.Users;
using Dobany.Dto;
using Dobany.EntityHistory;
using EntityHistoryHelper = Dobany.EntityHistory.EntityHistoryHelper;

namespace Dobany.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : DobanyAppServiceBase, IAuditLogAppService
    {
