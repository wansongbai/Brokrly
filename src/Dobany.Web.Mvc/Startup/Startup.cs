...
using Dobany.Schemas;
using Dobany.Web.Chat.SignalR;
using Dobany.Web.Common;
using Dobany.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using Dobany.Web.IdentityServer;
using Dobany.Web.Swagger;
using Stripe;
...
using Dobany.Web.HealthCheck;
using Owl.reCAPTCHA;
using HealthChecksUISettings = HealthChecks.UI.Configuration.Settings;
using Microsoft.AspNetCore.Server.Kestrel.Https;

namespace Dobany.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerDoc("v1", new OpenApiInfo() {Title = "Dobany API", Version = "v1"});
            ...
            return services.AddAbp<DobanyWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "Dobany API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("Dobany.Web.wwwroot.swagger.ui.index.html");
