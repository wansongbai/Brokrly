(function () {
    ...
    app.modals.ManageDynamicEntityPropertyValuesModal.create = function () {
        return new app.ModalManager({
            viewUrl: abp.appPath + 'Admin/DynamicEntityPropertyValue/ManageDynamicEntityPropertyValuesModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Admin/Views/DynamicEntityPropertyValues/ManageDynamicEntityPropertyValuesModal.js',
