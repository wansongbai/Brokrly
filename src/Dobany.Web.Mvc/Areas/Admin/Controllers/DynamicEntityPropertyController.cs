...
using Dobany.Web.Areas.Admin.Models.DynamicEntityProperty;
...
namespace Dobany.Web.Areas.Admin.Controllers
{
    ...
    public class DynamicEntityPropertyController : DobanyControllerBase
    {
        ...
        [HttpGet]
        [Route("/Admin/DynamicEntityProperty/{entityFullName}")]
