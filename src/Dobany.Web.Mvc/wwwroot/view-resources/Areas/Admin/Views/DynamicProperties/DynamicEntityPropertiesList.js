(function () {
    $(function () {
        ...
        var _selectAnEntity = new app.ModalManager({
            viewUrl: abp.appPath + 'Admin/DynamicProperty/SelectAnEntityModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Admin/Views/DynamicProperties/_SelectAnEntityModal.js',
                    ...
                    },
                    {
                        ...
                        rowAction: {
                            element: $("<button/>")
                                ...
                                .click(function () {
                                    window.location.href = "/Admin/DynamicEntityProperty/" + $(this).data().entityFullName;
                                })
                        }
                    },
                    {
