(function () {
    $(function () {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Admin/DynamicProperty/CreateOrEditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Admin/Views/DynamicProperties/_CreateOrEditModal.js',
            modalClass: 'CreateOrEditDynamicPropertyModal',
            cssClass: 'scrollable-modal'
        });

        var _manageValuesModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Admin/DynamicProperty/ManageValuesModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Admin/Views/_Bundles/dynamic-properties-manage-values.min.js',
