(function ($) {
    app.modals.UserDelegationsModal = function () {
        ...
        var _createNewUserDelegationModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Admin/Profile/CreateNewUserDelegationModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Admin/Views/Profile/_CreateNewUserDelegationModal.js',
