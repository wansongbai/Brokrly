(function () {
    ...
    app.modals.InactivityControllerNotifyModal.create = function () {
        var modal = new app.ModalManager({
            viewUrl: abp.appPath + 'Admin/Common/InactivityControllerNotifyModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Admin/Views/Common/Modals/_InactivityControllerNotifyModal.js',
