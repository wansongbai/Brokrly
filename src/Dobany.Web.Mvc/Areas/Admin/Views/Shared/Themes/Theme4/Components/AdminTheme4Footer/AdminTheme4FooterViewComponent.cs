...
namespace Dobany.Web.Areas.Admin.Views.Shared.Themes.Theme4.Components.AdminTheme4Footer
{
    public class AdminTheme4FooterViewComponent : DobanyViewComponent
    {
