...
using Dobany.Core.Base;
using Dobany.Core.Extensions;
using Dobany.Dto;
using Dobany.Types;

namespace Dobany.Queries
{
    public class OrganizationUnitQuery : DobanyQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
