...
using Dobany.DemoUiComponents.Dto;

namespace Dobany.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : DobanyAppServiceBase, IDemoUiComponentsAppService
    {
