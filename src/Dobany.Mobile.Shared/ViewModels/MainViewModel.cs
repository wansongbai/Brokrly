...
using Dobany.Commands;
using Dobany.Core.Threading;
using Dobany.Models.NavigationMenu;
using Dobany.Services.Navigation;
using Dobany.ViewModels.Base;
using Plugin.Media;
...
using Dobany.ApiClient;
using Dobany.Controls;
using Dobany.Dto;
using Dobany.Extensions;
using Dobany.Localization;
using Dobany.UI;
using Dobany.UI.Assets;
using Dobany.Views;
using DependencyResolver = Dobany.Core.Dependency.DependencyResolver;

namespace Dobany.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Dobany";
