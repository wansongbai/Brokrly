...
namespace Dobany.Authorization.Accounts
{
    public class AccountAppService : DobanyAppServiceBase, IAccountAppService
    {
        ...
        public async Task<RegisterOutput> Register(RegisterInput input, bool captchaDisabled = true)
        {
            if (!captchaDisabled && UseCaptchaOnRegistration())
            {
